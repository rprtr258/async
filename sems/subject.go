...
func PageSubject(w *HTTPResponse, r *HTTPRequest) error {
...
func PageSubjectCreate(w *HTTPResponse, r *HTTPRequest) error {
	session, err := GetSessionFromRequest(r)
	if err != nil {
		return UnauthorizedError
	}
...
func PageSubjectEdit(w *HTTPResponse, r *HTTPRequest) error {
	session, err := GetSessionFromRequest(r)
	if err != nil {
		return UnauthorizedError
	}
...
func HandlerSubjectCreate(w *HTTPResponse, r *HTTPRequest) error {
	session, err := GetSessionFromRequest(r)
	if err != nil {
		return UnauthorizedError
	}
	...
	if !StringLengthInRange(name, MinSubjectNameLen, MaxSubjectNameLen) {
		return WritePage(w, r, PageSubjectCreate, BadRequest("subject name length must be between %d and %d characters long", MinSubjectNameLen, MaxSubjectNameLen))
	}
...
func HandlerSubjectEdit(w *HTTPResponse, r *HTTPRequest) error {
	session, err := GetSessionFromRequest(r)
	if err != nil {
		return UnauthorizedError
	}
